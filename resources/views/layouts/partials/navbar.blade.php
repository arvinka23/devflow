    ...
    <div class="flex items-center justify-between h-full px-6">
            ...
            <div class="hidden sm:flex items-center">
                <form action="{{ route('search') }}" method="GET">
                    <div class="relative">
                        ...
                        <input type="text" name="q" value="{{ request('q') }}" placeholder="Search projects & tasks..."
                               autocomplete="off"
        ...
        <div class="flex items-center gap-2">
            <button onclick="toggleTheme()" class="p-2 rounded-lg hover:bg-muted transition-colors">
                ...
                <svg class="w-5 h-5 text-muted-foreground block dark:hidden" fill="none" stroke="currentColor" viewBox="0 0 24 24">
